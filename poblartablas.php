...
$dropTABLE_AGENCIABUSES="DROP TABLE AGENCIABUSES";
$dropTABLE_AGENCIAVIAJES="DROP TABLE AGENCIAVIAJES";
$dropTABLE_AGENCIAVIAJESCLIENTE="DROP TABLE AGENCIAVIAJESCLIENTE";
$dropTABLE_AGENCIAVIAJESDESTINO="DROP TABLE AGENCIAVIAJESDESTINO";
$dropTABLE_BUS="DROP TABLE BUS";
$dropTABLE_CLIENTE="DROP TABLE CLIENTE";
$dropTABLE_DESTINO="DROP TABLE DESTINO";
$dropTABLE_RELACIONAGENCIAS="DROP TABLE RELACIONAGENCIAS";
$dropTABLE_VIAJAR="DROP TABLE VIAJAR";
