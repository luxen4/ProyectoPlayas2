...
$pueblaDESTINO="INSERT INTO DESTINO (/*codDestino,*/nombre_Lugar,prov_Depart,com_Reg,pais,dia_Semana,fecha_Viaje,cod_agenciaOferta,kilometrosIdaVuelta,euros,cod_bus)  
	...
	('Santoña','Cantabria','Cantabria','España',/*DAYNAME('2021-09-12') para Ingés*/ELT(WEEKDAY('2021-09-21') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-11',1,202.4,12,1),
	('Zarautz','Guipuzkoa','País Vasco','España',ELT(WEEKDAY('2021-10-12') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-12',1,174,12,2),
	('Castro Urdiales','Cantabria','Cantabria','España',ELT(WEEKDAY('2021-10-18') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-18',1,118,12,2),
	('Fuenterrabía','Bizkaia','País Vasco','España',ELT(WEEKDAY('2021-10-19') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-19',1,183,12,3),
	('Laredo','Cantabria','Cantabria','España',ELT(WEEKDAY('2021-10-25') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-25',1,132,12,3),
	('San Sebastián','Guipúzcoaa','País Vasco','España',ELT(WEEKDAY('2021-10-26') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-26',1,102,12,4),

						
	('Hendaya','Pirineos Atlanticos','N. Aquitania','Francia',ELT(WEEKDAY('2021-09-28') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-28',2,174,12,5),
	('San Juán de Luz','Pirineos Atlanticos','Nueva Aquitania','Francia',ELT(WEEKDAY('2021-09-29') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-29',2,193,12,6),
	...
	('Santander','Guipuzkoa','País Vasco','España',ELT(WEEKDAY('2021-10-05') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-05',3,157,14,10),
	('Castro Urdiales','Cantabria','Cantabria','España',ELT(WEEKDAY('2021-10-06') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-06',3,118,14,10),
	('Fuenterrabía','Bizkaia','País Vasco','España',ELT(WEEKDAY('2021-10-08') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-08',3,183,14,11),
	('Noja','Cantabria','Cantabria','España',ELT(WEEKDAY('2021-10-10') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-10',3,174,14,12), 

						
	('San Juán de Luz','Pirineos Atlanticos','N. Aquitania','Francia',ELT(WEEKDAY('2021-09-14') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-14',4,193,14,13),
	('Laredo','Cantabria','Cantabria','España',ELT(WEEKDAY('2021-10-16') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-16',4,132,14,14),
	('Zarautz','Guipuzkoa','País Vasco','España',ELT(WEEKDAY('2021-10-25') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-25',4,174,14,15),
	('Fuenterrabía','Bizkaia','País Vasco','España',ELT(WEEKDAY('2021-10-29') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-29',4,183,14,16),
						

	('Laredo','Cantabria','Cantabria','España',ELT(WEEKDAY('2021-10-12') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-12',5,132,14,17),
	('Zarautz','Guipuzkoa','País Vasco','España',ELT(WEEKDAY('2021-10-19') + 1, 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo'),'2021-10-19',5,174,14,18)
;";
