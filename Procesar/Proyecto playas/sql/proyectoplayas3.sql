...
--Vamos a seguir la lógica: 1º Crear las agencias.
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------					
 CREATE TABLE AGENCIAVIAJES(
	...
	lugarSalidaPredeterminado  VARCHAR (100) NOT NULL,	
	compañiaBusHabitual	VARCHAR (30) NOT NULL,	
	horaEntrManana      VARCHAR (20) NOT NULL,
	horaSalManana		VARCHAR (20) NOT NULL,
	horaEntrTarde		VARCHAR (20) NOT NULL,
	horasalTarde		VARCHAR (20) NOT NULL,
	/*horarioAgencia	    NVARCHAR (80)  DEFAULT N'10:00 a 13:00 y 17:00 a 20:00' NOT NULL,	*/
	telefonoDeReserva	VARCHAR (15)  CONSTRAINT dfTelefonoDeReservaAgenciaViajes DEFAULT N'NO' NOT NULL,	
	telefonoAgencia		VARCHAR (15)  CONSTRAINT dfTelefonoAgenciaAgenciaViajes DEFAULT N'NO' NOT NULL,
	pagoOnline			VARCHAR (15)  CONSTRAINT dfPagoOnlineAgenciaViajes DEFAULT N'NO' NOT NULL,
	numCuenta           VARCHAR (70),
	email				VARCHAR (100) DEFAULT N'-NO TIENE-' NOT NULL,		-- Siempre meter el parentesis que si nó, trunca --
	contrasena			VARCHAR (100) NOT NULL															-- restricciones y foreign keys (LA DE PERSONAL)
		
		CONSTRAINT PkAgenciaViajes
			PRIMARY KEY (codAgenciaViajes),

		CONSTRAINT ckValTelefonoDeReservaAgenciaViajes 
			CHECK (UPPER (telefonoDeReserva) in ('SI','NO') or (ISNUMERIC (telefonoDeReserva) = 1)), 

		CONSTRAINT ckValDfTelefonoAgenciaAgenciaViajes
			CHECK (UPPER (telefonoAgencia) in ('SI','NO')   or (ISNUMERIC (telefonoAgencia) = 1)), 
...
SELECT * FROM AGENCIAVIAJES;
   ...
   /*Se queda obsoleto con la modificacion*/
INSERT INTO AGENCIAVIAJES (/*codigoAgencia*/nombre,nif,direcion,cp,localidad,provincia,comunidad,pais,lugarSalidaPredeterminado,compañiaBusHabitual,horaEntrManana,horaSalManana,horaEntrTarde,horaSalTarde, 
											telefonoDeReserva,telefonoAgencia,pagoOnline,numCuenta,email,contrasena)
	VALUES	('PONIENTE',678912345,'C/Beratua 36',26008,'Logroño','La Rioja','La Rioja','España',                              'General Urrutia','Autobuses Jimenez',					'10:00:00','12:00:00','14:00:00','18:00:00',		'SI',12345,default,default,default,'Alberite'),
		    ('GO TRAVEL CLUB "PlayaBus',234567890,'Avda. Jorge Vigón 7-9',26007,'Logroño','La Rioja','La Rioja','España',     'Muro de la Mata (Cafetería Ibiza)','Autobuses Logrobús',	'10:00:00','12:00:00','14:00:00','18:00:00',		1234586,12345,default,default,'info.gotraveltour@gmail.com','contrasengotravel'),
		    ('VIAJES AZUL MARINO',345678901,'C/Lardero 3',26001,'Logroño','La Rioja','La Rioja','España',                     'Muro de la Mata (Cafetería Ibiza)','Autobuses Logrobús',	'10:00:00','12:00:00','14:00:00','18:00:00',		1234586,12345,default,default,'info.azulmarino@gmail.com','contrasenazulMarino'),
			('VIAJES GRAN RESERVA',456789123,'C/Vara de Rey 41',26003,'Logroño','La Rioja','La Rioja','España',               'Estación de autobuses','Autobuses Yanguas',				'10:00:00','12:00:00','14:00:00','18:00:00',		1234586,602263181,default,default,'granReserva@gmail.com','granreservaContraseña'),		 --  autobuses propios de Yanguas.   14 adulto 11 euros niño(menores hasta 10años)
			('F.R.P. Y JUBILADOS DE CC.OO (LA RIOJA)',567891234,'C/Pio XII 1',26003,'Logroño','La Rioja','La Rioja','España', 'Estación de autobuses', 'Autobuses Riojacar',			'10:00:00','12:00:00','14:00:00','18:00:00',		123458,602263181,default,default,'jubilados@gmail.com','jubiladosContraseña')				 -- Precio de Billete 12euros (afiliados 10 euros)			
;
/*------------------------------------------*/
...
INSERT INTO AGENCIAVIAJES (nombre,nif,direcion,localidad,provincia,comunidad,pais,lugarSalidaPredeterminado,compañiaBusHabitual,horarioAgencia,telefonoDeReserva,telefonoAgencia,pagoOnline,email)
	VALUES	(N'aa',6,N'a',N'aa',N'aa',N'aa',N'España',N'aa',N'aa','aa',11,11,N'NO','aa')
;
-- -----------------------------------
...
INSERT INTO autobus(matricula, tipoBus, plazas) VALUES('LO-9854-F','Grande',62);																										
SELECT * FROM autobus;
DROP TABLE autobus;
-- ---------------------------------------
